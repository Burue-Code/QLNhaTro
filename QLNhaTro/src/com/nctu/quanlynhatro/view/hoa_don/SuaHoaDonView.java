...
public class SuaHoaDonView extends JDialog {
	...
	public SuaHoaDonView(DefaultTableModel model, int row) {
		...
		txtNgayThanhToan.setText(getValue(3));
		...
		txtMaHopDong.setText(getValue(0));
		...
		txtTongThanhToan.setText(getValue(4));
		...
		btnCapNhat.addActionListener(e -> {
			...
			mainTableModel.setValueAt("Đã thanh toán", rowIndex, 4);
