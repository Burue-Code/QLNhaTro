...
public class PhuongThucThanhToanView extends JPanel {
    ...
    public PhuongThucThanhToanView() {
        ...
        // 1.1 Tiêu đề
        JLabel lblTitle = new JLabel("DANH SÁCH PHƯƠNG THỨC THANH TOÁN", SwingConstants.CENTER);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new PhuongThucThanhToanView().setVisible(true));
    }
}