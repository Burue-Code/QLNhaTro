...
public class ThemKhachHangView extends JDialog {
	...
	public ThemKhachHangView(DefaultTableModel model) {
		...
		txtNgaySinh = new MyTextField("yyyy-mm-dd VD:2000-01-01");
	...
	public String getGioiTinh() {
		return rdoNam.isSelected() ? "Nam" : "Nữ";
	}
	...
	public String getMaKhachHangChinh() {
		return txtMaKHChinh.getText().trim();
	}

	public String getTenKhachHangChinh() {
		return txtTenKHChinh.getText().trim();
	}
	...
	public MyTable getTblKhachHang() {
		return tblKhachHang;
	}

	public DefaultTableModel getTableModelDS() {
		return tableModelDS;
	}

	public void setTenKhachHang(String ten) {
		this.txtTenKH.setText(ten);
	}
	...
	public void setMaKhachHangChinh(String maKH) {
		this.txtMaKHChinh.setText(maKH);
	}

	public void setTenKhachHangChinh(String tenKH) {
		this.txtTenKHChinh.setText(tenKH);
	}
