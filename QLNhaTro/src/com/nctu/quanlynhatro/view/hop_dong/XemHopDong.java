...
public class XemHopDong extends JFrame {
    ...
    public XemHopDong() {
        ...
        // =========================
        // BOTTOM: BUTTONS (Thoát | Xóa | Sửa) canh phải
        // =========================
    ...
    private void addLabeledField(JPanel parent, GridBagConstraints gbc, int col, int row, String label, JComponent field) {
