...
public class SuaHopDongView extends JDialog {
	...
	public SuaHopDongView(DefaultTableModel model, int row) {
		...
		txtNgayKetThuc.setText(getValue(5));
		...
		cboPhong.setSelectedItem(getValue(1));
